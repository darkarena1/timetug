...
| Which events take over | Per-calendar opt-in, plus defaults: skip all-day, skip declined, skip events with no other attendees; optional "video link only" |
