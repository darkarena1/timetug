...
enum WindowsTimeZones {
    ...
    /// IANA identifiers that name the same zone as a table entry but are spelled differently (the newer canonical
    /// names), so writing an event in one of them still finds its Windows name.
    private static let aliases: [String: String] = [
        "Asia/Kolkata": "Asia/Calcutta", "Asia/Kathmandu": "Asia/Katmandu", "Asia/Yangon": "Asia/Rangoon",
        "Europe/Kyiv": "Europe/Kiev", "America/Nuuk": "America/Godthab", "America/Buenos_Aires": "America/Argentina/Buenos_Aires",
        "America/Indiana/Indianapolis": "America/Indianapolis", "America/Chihuahua": "America/Mazatlan",
        "UTC": "Etc/UTC", "GMT": "Etc/UTC", "Etc/GMT": "Etc/UTC", "Etc/Universal": "Etc/UTC", "Z": "Etc/UTC",
    ]

    private static let reverse: [String: String] = {
        var map: [String: String] = [:]
        for (windows, iana) in table { map[iana] = windows }
        for (alias, iana) in aliases { if let windows = map[iana] { map[alias] = windows } }
        return map
    }()
