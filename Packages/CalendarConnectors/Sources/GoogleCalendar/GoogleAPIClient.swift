        ...
        do {
            try await pages(
                ...
                query: [
                    ...
                    URLQueryItem(name: "fields", value: "nextPageToken,items(id,summary,summaryOverride,backgroundColor,accessRole,primary,timeZone,hidden,deleted,defaultReminders(method,minutes))"),
                ],
